...
set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { hz_led }]; #IO_L24N_T3_35 Sch=led[4]
#set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_25_35 Sch=led[5]
set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { blink_led }]; #IO_25_35 Sch=led[5]
...
set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { trig }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
